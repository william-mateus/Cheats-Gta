...
import br.com.willaimsilva.cheatsgta.databinding.ItemCheats2Binding
import br.com.willaimsilva.cheatsgta.databinding.ItemCheatsIvBinding
import br.com.willaimsilva.cheatsgta.model.Cheats

class Cheats2Adpter (private val cheats: List<Cheats>): RecyclerView.Adapter<Cheats2Adpter.ViewHolder>() {
    class ViewHolder(val binding: ItemCheats2Binding) : RecyclerView.ViewHolder(binding.root)

    // infla o layout "gera objeto"
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = ItemCheats2Binding.inflate(inflater, parent, false)
