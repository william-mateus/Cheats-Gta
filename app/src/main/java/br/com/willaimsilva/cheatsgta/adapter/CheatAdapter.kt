...
class CheatAdapter(private val cheats: List<Cheats>): RecyclerView.Adapter<CheatAdapter.ViewHolder>() {

    class ViewHolder(val binding: ItemCheatsBinding) : RecyclerView.ViewHolder(binding.root)

    // infla o layout "gera objeto"
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding = ItemCheatsBinding.inflate(inflater, parent, false)
